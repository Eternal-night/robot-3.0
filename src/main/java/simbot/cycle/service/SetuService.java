...
public class SetuService {
    ...
    public ReString setuTimeCheck(Long userId, String userNick) {
        ...
        //操作间隔判断
//        String timeCheck = rabbitBotService.commandTimeSplitCheck(ConstantPixiv.SETU_PID_SPLIT_MAP, userId, userNick, SETU_PID_SPLIT_TIME, RandomUtil.rollStrFromList(ConstantPixiv.SETU_SPLIT_ERROR_LIST));
//        if (StringUtils.isNotEmpty(timeCheck)) {
            reString = new ReString(false, "");
      //  }
        return reString;
    }
